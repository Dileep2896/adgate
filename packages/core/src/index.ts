/**
 * @adgateio/core: pure logic (no HTTP, DB, env or network). One module per responsibility, all
 * re-exported here. Depends on @adgateio/schemas only; never the other way round.
 */
...
export { PolicyValidationError } from '@adgateio/schemas';
