...
export const CLASSIFIER_PROMPT: string = [
  ...
  paragraph(
    ...
    'debugging or writing code the user already has, explaining a concept, homework,',
    'casual chat, or creative work such as naming, wording or drafting something the user is',
    'making. Calibrate roughly: 0.8 to 1.0 for "which X should I use" or "X vs Y";',
    '0.4 to 0.7 for a topic where a product would help but none was asked for; 0.0 to 0.2',
    'for pure explanation, creative work or chat. Worked examples: "how do I fix this stack',
    'trace" is 0.1 and "what should I call my app" is 0.1, while "what is a good tool for',
    'tracking errors in production" is 0.9.',
  ),
  paragraph(
  ...
  paragraph(
    ...
    '"finance" for the user\'s own money: debt, credit, savings, investing, insurance, taxes or',
    'how they are doing financially. Paying for a product is not itself a money decision, so',
    'shopping for or subscribing to something is not "finance" unless the conversation is about',
    'the money behind it;',
