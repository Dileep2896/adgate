...
/**
 * Adult: pornography, sex work, explicit content. "adult" alone is weak (adult education), so
 * is "naked" (naked domain, naked eye).
 */
export const ADULT: SensitiveRuleSet = {
  ...
  strong: [
    ...
    'escort', 'escorts', 'sex', 'sexual', 'sexy', 'nude', 'nudes', 'nudity', 'erotic',
  ...
  weak: ['adult', 'mature', 'explicit', 'lingerie', 'kinky', 'hook up', 'dating', 'naked'],
  patterns: [
